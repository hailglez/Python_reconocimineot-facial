...
import os
import imutils
dataRuta='C:/Users/hail.gonzalez/Desktop/proyectos python/curso/reconocimientofacial1/Data'
listaData=os.listdir(dataRuta)
entrenamientoEigenFaceRecognizer=cv.face.LBPHFaceRecognizer_create()
entrenamientoEigenFaceRecognizer.read('EntrenamientoEigenFaceRecognizer.xml')
ruidos=cv.CascadeClassifier('C:/Users/hail.gonzalez/Desktop/proyectos python/curso/reconocimientofacial1/haarcascade_frontalface_default.xml')
